...
def analyze_udp_header(data_recv):
	...
	print("_______________________UDP HEADER_______________________")
...
def analyze_tcp_header(data_recv):
	...
	print("___________________TCP HEADER_________________")
	print("Source: %hu " % src_port)
	print("Destination: %hu " % dst_port)
	print("Seq: %u " % seq_num)
	print("Ack: %u " % ack_num)
...
def analyze_IP_header(data_recv):
	...
	ip_hdr = struc.unpack('!6H4s4s',data_recv[:20])
	...
	print("__________________IP HEADER_________________")
...
def analyze_ether_header(data_recv):
	...
	print("_____________________ETHERNET HEADER____________________")
