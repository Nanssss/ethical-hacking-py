...
**Utilisation :**
**sudo python3 arpspooferforwarding.py**, il va vous demander l'IP du routeur et l'IP de la victime. Une fois celà fait, l'attaque est en cours.

## synflood.py

Ce programme est un SYN flooder, il sert à faire des attaques DOS (Denial Of Service). On initie à répétition des connexions à la cible sans les fermer. Le but est de saturer le serveur.
